...
public class LexicalAndSyntaxPublicTest {
    ...
    @Test
    public void testParserPass13() {
        ErrorHandler.INSTANCE.reset();
        int result = lexAndSyntax.parser(path_parser + "pass13.jova", debug);
        assertEquals(0, result);
    }

    @Test
    public void testParserPass14() {
        ErrorHandler.INSTANCE.reset();
        int result = lexAndSyntax.parser(path_parser + "pass14.jova", debug);
        assertEquals(0, result);
    }
    ...
    @Test
    public void testParserFail27() {
        ErrorHandler.INSTANCE.reset();
        int result = lexAndSyntax.parser(path_parser + "fail27.jova", debug);
        assertTrue(result > 0);
    }

    @Test
    public void testParserFail28() {
        ErrorHandler.INSTANCE.reset();
