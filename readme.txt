...
- Supported data types:
    ...
    - Dead code elimination: str, int, bool, class type
    - Constants propagation: int, bool
    - Copy propagation: str, int, bool, class type
...
- Test cases:
    - Test cases are located in the main test input folder for this assignment: "src/test/resources/private/code_optimization/input".
    - Jasmin files for bonus test cases are generated by specifying them in the main test class and running "CodeOptimizerPrivateTest.buildBonusTests()".
    - Test cases:
